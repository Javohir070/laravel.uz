...
<div class="flex justify-between align-center mt-10">
    ...
    <h2 class="intro-y text-lg font-medium">Masul qo'shish</h2>
...
<div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2" style="background: white;
    ...
    <div class="w-full mt-3 sm:mt-0 sm:ml-auto md:ml-0">
        <form id="science-paper-create-form" method="POST" action="{{ route("responsible.store") }}" class="validate-form"
            ...
            <div class="grid grid-cols-12 gap-2">
                <div class="w-full col-span-6 ">
                    ...
                    <input type="text" name="department" value="{{ old('department') }}" class="input w-full border mt-2" required="">
                    @error('department')
                ...
                <div class="w-full col-span-6 ">
                    ...
                    <input type="text"  name="email" value="{{ old('email') }}"   class=" input w-full border mt-2" required="">
                    @error('email')
                        <div class="error">{{ $message }}</div>
                    @enderror
                </div>
